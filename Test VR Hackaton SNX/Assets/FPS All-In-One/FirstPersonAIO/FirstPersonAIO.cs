...
//        if(vcr.mode != InputVCRMode.Playback){
    ...
    if(advanced.useSlopeDetection){
        ...
        if(useVCR){
          //   horizontalInput = vcr.GetAxis("Horizontal");
           //  verticalInput = vcr.GetAxis("Vertical");
